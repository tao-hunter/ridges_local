...
def are_patches_too_similar(patch1: str, patch2: str, threshold: float = 0.95) -> bool:
    """Returns True if patches are too similar based on cosine similarity."""
    vectorizer = TfidfVectorizer().fit([patch1, patch2])
    vectors = vectorizer.transform([patch1, patch2])

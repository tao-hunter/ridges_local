...
async def create_agent(agent: MinerAgent) -> None: ...
async def store_agent_version(agent_version: any) -> None: ...
...
async def get_agent_version(version_id: str) -> any: ...
...
async def get_evaluation(evaluation_id: str) -> Evaluation: ...

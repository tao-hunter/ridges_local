...
def run():
    ...
    # Start platform
    if run_cmd(f'pm2 start "DD_SERVICE="ridges-platform" DD_ENV="prod" DD_LOGS_INJECTION=true ddtrace-run uv run -m api.src.main" --name ridges-api-platform', capture=False)[0] == 0:
